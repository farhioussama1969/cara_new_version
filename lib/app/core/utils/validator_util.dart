...
class ValidatorUtil {
  ...
  static String? creditCardExpiredDateValidation(String expiredDate,
      {String? customMessage}) {
    if (!CreditCardValidator()
        .validateExpDate(expiredDate)
        .isPotentiallyValid) {
      return customMessage ??
          StringsAssetsConstants.validatorDefaultErrorMessage;
    }
  ...
  static String? creditCardCvvValidation(String cvv, String cardNumber,
      {String? customMessage}) {
    if (!CreditCardValidator()
        .validateCVV(
            cvv, CreditCardValidator().validateCCNum(cardNumber).ccType)
        .isPotentiallyValid) {
      return customMessage ??
          StringsAssetsConstants.validatorDefaultErrorMessage;
    }
