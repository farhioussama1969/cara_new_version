...
class ThemeStyles {
  static ThemeData lightTheme = ThemeData.light().copyWith(
    ...
    colorScheme: ColorScheme.fromSwatch().copyWith(secondary: MainColors.primaryColor).copyWith(background: LightColors.backgroundColor),
  );
  ...
  static ThemeData darkTheme = ThemeData.dark().copyWith(
    ...
    colorScheme: ColorScheme.fromSwatch().copyWith(secondary: MainColors.primaryColor).copyWith(background: DarkColors.backgroundColor),
  );
}
